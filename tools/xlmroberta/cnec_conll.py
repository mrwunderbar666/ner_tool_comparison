...
df_train = pd.read_feather(p_corpus / 'named_ent_train.feather')
df_test = pd.read_feather(p_corpus / 'named_ent_dtest.feather')
df_validation = pd.read_feather(p_corpus / 'named_ent_etest.feather')
